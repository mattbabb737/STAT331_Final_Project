...
This table below shows each country's mean child mortality, mean emissions per capita, and the log transformation of its mean emissions per capita, averaged across all of the years contained within the final_data set.
...
kable_lm <- kable(tidy_lm, format = "html", caption = "Summary of Linear Model", digits = 4)
